...
Rails.application.configure do
  ...
  config.action_mailer.smtp_settings = {
    address: ENV.fetch("MAILER_SMTP_ADDRESS", "smtp.gmail.com"),
    port: ENV.fetch("MAILER_SMTP_PORT", "587").to_i,
    domain: ENV.fetch("MAILER_SMTP_DOMAIN", "gmail.com"),
    user_name: ENV.fetch("MAILER_SMTP_USERNAME"),
    password: ENV.fetch("MAILER_SMTP_PASSWORD"),
    authentication: ENV.fetch("MAILER_SMTP_AUTH", "plain").to_sym,
